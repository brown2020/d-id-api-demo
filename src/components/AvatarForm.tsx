                  ...
                  <div className="mt-3 w-full text-center sm:ml-4 sm:mt-0 sm:text-left">
                    ...
                    <div className="w-full mt-4 mb-5">
                        ...
                        render={({ field }) =>
                          fetchingAudio ? (
                            ...
                            <div className="py-2 px-3 border border-amber-200 bg-amber-50 rounded text-sm text-amber-700">
                              <p>
                                No voices found. Please ensure you have added
                                your ElevenLabs API key in your profile.
                              </p>
                              <p className="mt-1">
                                <a
                                  href="/profile"
                      ...
                      {voiceDetail ? (
                        <audio
                          controls
                          key={voiceDetail.voice_id}
                          className="mt-2"
                        >
                          <source
                            src={voiceDetail.preview_url}
                            type="audio/mpeg"
                          />
