...
export const getApiBaseUrl = () => process.env.NEXT_PUBLIC_IS_LOCAL == "1" && process.env.NEXT_PUBLIC_API_BASE_URL ? process.env.NEXT_PUBLIC_API_BASE_URL : window.location.origin;
